...
export default function Body() {
    ...
    function nextQuestion() {
        setQuestionNumber(prevQNumber => (prevQNumber + 1) === (theQuestions.length) ? 0 : prevQNumber + 1)
        setSwitchQnA(true)
    }
    function lastQuestion() {
        setQuestionNumber(prevQNumber => prevQNumber === 0 ? theQuestions.length - 1 : prevQNumber - 1)
        setSwitchQnA(true)
    }

    return (
        <main>            
            <Question qn={theQuestions[questionNumber]} handleSwitchQna={toggleQnA} switchQnA={switchQnA} />
